...
%MSDEV% utils/bsp31migrate/bsp31migrate.dsp %CONFIG%"bsp31migrate - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/hlmv/hlmv.dsp %CONFIG%"hlmv - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/p2csg/p2csg.dsp %CONFIG%"p2csg - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/p2bsp/p2bsp.dsp %CONFIG%"p2bsp - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/p2vis/p2vis.dsp %CONFIG%"p2vis - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/p2rad/dlight.dsp %CONFIG%"dlight - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/p2rad/hlrad.dsp %CONFIG%"hlrad - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/p2rad/p1rad.dsp %CONFIG%"p1rad - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/p2rad/p2rad.dsp %CONFIG%"p2rad - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1
%MSDEV% utils/makefont/makefont.dsp %CONFIG%"makefont - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/maketex/maketex.dsp %CONFIG%"maketex - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/makewad/makewad.dsp %CONFIG%"makewad - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/decal2tga/decal2tga.dsp %CONFIG%"decal2tga - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/stalker2tga/stalker2tga.dsp %CONFIG%"stalker2tga - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/reqtest/reqtest.dsp %CONFIG%"reqtest - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

%MSDEV% utils/spritegen/spritegen.dsp %CONFIG%"spritegen - Win32 Debug" %build_target%
if errorlevel 1 set BUILD_ERROR=1

...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "./" /I "../common" /I "../pm_shared" /I "../engine" /I "../game_shared" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /FD /c
# SUBTRACT CPP /YX
...
# Begin Custom Build
TargetDir=\Paranoia2\src_main\temp\mainui\!release
InputPath=\Paranoia2\src_main\temp\mainui\!release\menu.dll
SOURCE="$(InputPath)"

"D:\Paranoia2\base\bin\menu.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\menu.dll "D:\Paranoia2\base\bin\menu.dll"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "./" /I "../common" /I "../pm_shared" /I "../engine" /I "../game_shared" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /FR /FD /GZ /c
# SUBTRACT CPP /YX
...
# Begin Custom Build
TargetDir=\Paranoia2\src_main\temp\mainui\!debug
InputPath=\Paranoia2\src_main\temp\mainui\!debug\menu.dll
SOURCE="$(InputPath)"

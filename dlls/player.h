...
public:
	...
	float		m_flLastBlurAmount;		// blur amount at damage moment
	float		m_flCurBlurAmount;		// applied blur amount
	float		m_flBlurFadeTime;		// blur auto-expired time
	...
	// buz: real lightlevel (from 0 to 1)
	float	m_fLightlevel;
...
//	virtual void Think( void );
	...
	int GiveAmmo( int iAmount, const char *szAmmoName );
	...
	void	SendInitMessages(); // buz
	int	m_iInitMessagesSent; // buz
...
extern int	gmsgWeaponBody;
extern int	gmsgWeaponSkin;
extern int	gmsgPartEffect;
extern int	gmsgBlurEffect;
extern int	gmsgLevelTime;

...
//=========================================================
float CBigMomma :: MaxYawSpeed( void )
{
	float ys;
...
void CBigMomma :: LayHeadcrab( void )
{
	...
	UTIL_TraceCustomDecal( &tr, "mommabirth",RANDOM_FLOAT( 0.0f, 360.0f ));
...
void CBMortar::Touch( CBaseEntity *pOther )
{
	...
	if ( pOther->IsBSPModel() )
	{
		...
		UTIL_TraceCustomDecal( &tr, "mommasplat", RANDOM_FLOAT( 0.0f, 360.0f ));
	}
	else
	{

...
public:
	...
	static bool regCreateKey( HKEY hKey, const char *SubKey );
	static bool regGetValue( HKEY hKey, const char *SubKey, const char *Value, char *pBuffer );
	static bool regSetValue( HKEY hKey, const char *SubKey, const char *Value, char *pBuffer );

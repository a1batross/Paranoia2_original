...
EXTERN BOOL ( WINAPI * pwglSwapBuffers)(HDC);
EXTERN BOOL ( WINAPI * pwglCopyContext)(HGLRC, HGLRC, UINT);
EXTERN HGLRC ( WINAPI * pwglCreateContext)(HDC);
EXTERN HGLRC ( WINAPI * pwglCreateLayerContext)(HDC, int);
EXTERN BOOL ( WINAPI * pwglDeleteContext)(HGLRC);
EXTERN HGLRC ( WINAPI * pwglGetCurrentContext)(VOID);
EXTERN PROC ( WINAPI * pwglGetProcAddress)(LPCSTR);
EXTERN BOOL ( WINAPI * pwglMakeCurrent)(HDC, HGLRC);
EXTERN BOOL ( WINAPI * pwglShareLists)(HGLRC, HGLRC);
EXTERN BOOL ( WINAPI * pwglUseFontBitmaps)(HDC, DWORD, DWORD, DWORD);
EXTERN BOOL ( WINAPI * pwglUseFontOutlines)(HDC, DWORD, DWORD, DWORD, FLOAT, FLOAT, int, LPGLYPHMETRICSFLOAT);
EXTERN BOOL ( WINAPI * pwglDescribeLayerPlane)(HDC, int, int, UINT, LPLAYERPLANEDESCRIPTOR);
EXTERN int ( WINAPI * pwglSetLayerPaletteEntries)(HDC, int, int, int, CONST COLORREF *);
EXTERN int ( WINAPI * pwglGetLayerPaletteEntries)(HDC, int, int, int, COLORREF *);
EXTERN BOOL ( WINAPI * pwglRealizeLayerPalette)(HDC, int, BOOL);
EXTERN BOOL ( WINAPI * pwglSwapLayerBuffers)(HDC, UINT);
EXTERN BOOL ( WINAPI * pwglSwapIntervalEXT)( int interval );
EXTERN HGLRC ( WINAPI * pwglCreateContextAttribsARB)( HDC hDC, HGLRC hShareContext, const int *attribList );

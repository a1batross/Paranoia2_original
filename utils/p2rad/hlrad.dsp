...
# PROP Scc_ProjName ""$/SDKSrc/Tools/utils/hlrad", FVGBAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "..\common" /I "..\..\common" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "IGNORE_SEARCH_IN_WADS" /D "ALLOW_WADS_IN_PACKS" /D "HLRAD_GOLDSRC" /FD /c
# SUBTRACT CPP /YX
...
# Begin Custom Build
TargetDir=\Paranoia2\src_main\temp\hlrad\!release
InputPath=\Paranoia2\src_main\temp\hlrad\!release\hlrad.exe
SOURCE="$(InputPath)"

"D:\Paranoia2\tools\hlrad.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\hlrad.exe "D:\Paranoia2\tools\hlrad.exe"
...
# ADD CPP /nologo /MTd /W3 /Gm /Gi /GX /ZI /Od /I "..\common" /I "..\..\common" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "IGNORE_SEARCH_IN_WADS" /D "ALLOW_WADS_IN_PACKS" /D "HLRAD_GOLDSRC" /FAs /FR /FD /c
# SUBTRACT CPP /YX
...
# Begin Custom Build
TargetDir=\Paranoia2\src_main\temp\hlrad\!debug
InputPath=\Paranoia2\src_main\temp\hlrad\!debug\hlrad.exe
SOURCE="$(InputPath)"

...
#define EF_NOBUMP			(1<<12)	// no bump for this entity or light source
#define EF_LENSFLARE		(1<<13)	// enable lensflare effect for dynamic light
...
#define EF_NOSHADOW			(1<<28)	// ignore shadow for this entity or light source

...
// helper macroses
#define LEAF_INFO( leaf, mod )	((mextraleaf_t *)world->leafs + (leaf - mod->leafs)) 
#define INFO_LEAF( leaf, mod )	(mod->leafs + (leaf - (mextraleaf_t *)world->leafs)) 
...
typedef struct render_api_s
{
	...
	struct model_s*	(*pfnGetModel)( int modelindex );

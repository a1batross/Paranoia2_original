...
#define MAX_PICKUP_MESSAGES			14
#define PICKUP_MESSAGES_DISTANCE	(YRES(25))
#define PICKUP_MESSAGES_MINHEIGHT	(YRES(370))
...
//	void UpdateSpectatorPanel( void );
	...
	// buz
	int MsgFunc_ShowTextWindow( const char *pszName, int iSize, void *pbuf );

	// buz
	void CreatePickupMessagePanels();
	void InitializePickupMessagePanels();
	void CheckCurrentPickupMessagePanel(); // called from message panels...
	void AddPickupMessage( client_textmessage_t *msg );

	CPickupMessage* m_pPickupMessages[MAX_PICKUP_MESSAGES];
	int m_iCurrentPickupMessage;
...
//	SpectatorPanel *		m_pSpectatorPanel;
	...
	// buz
	CParanoiaTextPanel* m_pParanoiaText;

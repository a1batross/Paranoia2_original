...
public:
	...
	fff	char* pos = "јЅ¬√ƒ≈∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёя";
		int xpos = 0;
		...
		pos = "абвгдежзийклмнопрстуфхцчшщъыьэю€";
		xpos = 0;
		...
		drawSetTextPos(0,17);
		char* textstring = "»значально именовалась в правительственных объектах...";
		...
		int wide, tall;
		m_pFont->getTextSize("»значально именовалась в правительственных объектах...", wide, tall);
